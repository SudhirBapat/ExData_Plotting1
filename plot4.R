## Plot 4 program - make sure "household_power_consumption.txt" is in your working directory
...
## Plot 4 - here we are plotting the 4 differnt graphs in the same image by nesting the plot funtion
